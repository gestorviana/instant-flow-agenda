-- Atualizar list_available_slots para SQL puro (mais performático e simples)
-- Mantendo os nomes de parâmetros originais
...
WITH cfg AS (
  ...
  JOIN public.services s ON s.user_id = a.user_id
...
series AS (
  -- Gerar série de horários baseado no step
  SELECT
